        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-[#B0B3A6]">
              ...
              <li>
                <Link href="/sell" className="transition-colors hover:text-white">Start Selling</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-[#B0B3A6]">
              <li>
                <Link href="/faq" className="transition-colors hover:text-white">Help Center & FAQ</Link>
              </li>
              <li>
                <Link href="/shipping" className="transition-colors hover:text-white">Shipping & Returns</Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/trust" className="transition-colors hover:text-white">Trust & Safety</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-[#B0B3A6]">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:hello@neomarket.com" className="transition-colors hover:text-white">
                  hello@neomarket.com
                </a>
              </li>
            </ul>
