      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-3">
          {sellers.map((seller) => (
            <div
              key={seller.name}
              className="flex items-center gap-5 rounded-[30px] border border-[#E7E1D9] bg-[#FCFBF8] p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-sm"
            >
              ...
              <div>
                <h3 className="text-3xl font-medium text-[#161616]">
                  {seller.name}
                </h3>

                <div className="mt-2 flex items-center gap-2">
                  <Star
                    className="h-4 w-4 fill-[#D67B48] text-[#D67B48]"
                  />
                  ...
                  <span className="text-xs uppercase tracking-[0.18em] text-[#7B7B7B]">
                    {seller.badge}
                  </span>
                </div>

                <p className="mt-2 text-base text-[#707070]">
                  {seller.listings} listings • {seller.category}
                </p>
              </div>
            </div>
          ))}
